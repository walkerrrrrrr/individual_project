...
\begin{table}[h]
\centering
\begin{tabular}{@{}lcc@{}} % @{} removes padding at the start and end of the table
\toprule % Top horizontal line
\textbf{Name} & \textbf{Avg Time (ms)} & \textbf{Passed/Failed} \\
\midrule % Middle horizontal line, below the header
...
\midrule
Lock   & Concurrent lock modelling mutual exclusion       & 45.8                  \\
Future              & Future variable that is written to once and read multiple times & 36.3                  \\
Account             & Concurrent accounts exchanging debit and credit instructions  & 31.9                  \\
Account Future & Concurrent accounts where debit instructions are effected via futures  & 53.5                  \\
Master-Worker       & Master-worker parallel network            & 64.5                  \\
Session Types       & Session-typed communicating actors using one arbiter   & 102.9                 \\
\bottomrule \\
\end{tabular}%
}
